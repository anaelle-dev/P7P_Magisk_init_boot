...
**⚠️ ↑ doesn't seem to work: initiates a bootloop, even in safe mode, and even with magisk stable from topjohnwu ↑ ⚠️**


## Sources:

- [Factory Images for Pixel 7 Pro (cheetah) from **Google**](https://developers.google.com/android/images#cheetah)
- [Magisk by **topjohnwu**](https://github.com/topjohnwu/Magisk)
- [Kitsune Mask (aka Magisk Delta) by **HuskyDG**](https://github.com/HuskyDG/magisk-files/blob/main/main.md)
